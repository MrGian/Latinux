...
public interface LicenseCheckerCallback {
     ...
     *
     * @param reason Policy.LICENSED or Policy.RETRY typically. (although in theory
     *               the policy can return Policy.NOT_LICENSED here as well)
     */
     ...
     *
     * @param reason Policy.NOT_LICENSED or Policy.RETRY. (although in theory the
     *               policy can return Policy.LICENSED here as well --- perhaps the
